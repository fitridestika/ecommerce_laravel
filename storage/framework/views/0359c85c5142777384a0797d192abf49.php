...
<?php $__env->startSection('title', 'Admin Tambah Product'); ?>
...
<div class="main-content">
    <section class="section">
        ...
        <div class="card mt-4">
            <form action="<?php echo e(route('product.store')); ?>" class="needs-validation" novalidate=""
...
<?php echo $__env->make('layouts.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\famelaoktavianda\famelaoktavianda-app\resources\views/pages/admin/product/create.blade.php ENDPATH**/ ?>